...
def SetLanguageInDriver(driver,Language0,Language1):
    ...
    if targetlanguageSelected.text != "Russian":
        ...
        targetlanguageDropdownRus = targetlanguageDropdown.find_element(By.XPATH, "//button[contains(., '"+Language1+"')]")
...
class DeepLHandlerC:
    ...
    def start(self,sourcelanguage,targetlanguage):
        ...
        SetLanguageInDriver(self.driver_norm,sourcelanguage,targetlanguage)
        SetLanguageInDriver(self.driver_reverse, targetlanguage,sourcelanguage)
